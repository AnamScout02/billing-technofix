...
PACKAGES = {
    ...
    'trial': {
        ...
        'price': 0,
        'trial_days': 7,
        'limits': {'pelanggan': 50, 'mikrotik': None, 'olt': None, 'team': 3, 'loket': None, 'max_devices': 2},
        'features': {
    ...
    'starter': {
        ...
        'price': 150_000,
        'limits': {'pelanggan': 500, 'mikrotik': None, 'olt': None, 'team': 3, 'loket': 2, 'max_devices': 2},
        'features': {
            'mikrotik_api': True, 'odp_map': True, 'billing': True, 'broadcast': True,
            'loket': True, 'komisi_loket': True, 'payment_gateway': True, 'tiket': True,
            'bandwidth_on_demand': True, 'spk': True, 'absensi': True, 'mobile_app': True,
    ...
    'essential': {
        ...
        'price': 200_000,
        'limits': {'pelanggan': 750, 'mikrotik': None, 'olt': None, 'team': 4, 'loket': 2, 'max_devices': 2},
        'features': {
            'mikrotik_api': True, 'odp_map': True, 'billing': True, 'broadcast': True,
            'loket': True, 'komisi_loket': True, 'payment_gateway': True, 'tiket': True,
            'bandwidth_on_demand': True, 'spk': True, 'absensi': True, 'mobile_app': True,
    ...
    'standar': {
        ...
        'price': 300_000,
        'limits': {'pelanggan': 1000, 'mikrotik': None, 'olt': None, 'team': 6, 'loket': None, 'max_devices': 3},
        'features': {
            'mikrotik_api': True, 'odp_map': True, 'billing': True, 'broadcast': True,
            'loket': True, 'komisi_loket': True, 'payment_gateway': True, 'tiket': True,
            'bandwidth_on_demand': True, 'spk': True, 'absensi': True, 'mobile_app': True,
    ...
    'pro': {
        ...
        'price': 600_000,
        'limits': {'pelanggan': 2500, 'mikrotik': None, 'olt': None, 'team': 10, 'loket': None, 'max_devices': 3},
        'features': {
            'mikrotik_api': True, 'odp_map': True, 'billing': True, 'broadcast': True,
            'loket': True, 'komisi_loket': True, 'payment_gateway': True, 'tiket': True,
            'bandwidth_on_demand': True, 'spk': True, 'absensi': True, 'mobile_app': True,
    ...
    'advanced': {
        ...
        'price': 900_000,
        'limits': {'pelanggan': 4000, 'mikrotik': None, 'olt': None, 'team': 15, 'loket': None, 'max_devices': 4},
        'features': {
            'mikrotik_api': True, 'odp_map': True, 'billing': True, 'broadcast': True,
            'loket': True, 'komisi_loket': True, 'payment_gateway': True, 'tiket': True,
            'bandwidth_on_demand': True, 'spk': True, 'absensi': True, 'mobile_app': True,
    ...
    'business': {
        ...
        'price': 1_500_000,
        'limits': {'pelanggan': 7000, 'mikrotik': None, 'olt': None, 'team': 30, 'loket': None, 'max_devices': 4},
        'features': {
            'mikrotik_api': True, 'odp_map': True, 'billing': True, 'broadcast': True,
            'loket': True, 'komisi_loket': True, 'payment_gateway': True, 'tiket': True,
            'bandwidth_on_demand': True, 'spk': True, 'absensi': True, 'mobile_app': True,
    ...
    'enterprise': {
        ...
        'price': 3_000_000,
        'limits': {'pelanggan': 15000, 'mikrotik': None, 'olt': None, 'team': None, 'loket': None, 'max_devices': 5},
        'features': {
            'mikrotik_api': True, 'odp_map': True, 'billing': True, 'broadcast': True,
            'loket': True, 'komisi_loket': True, 'payment_gateway': True, 'tiket': True,
            'bandwidth_on_demand': True, 'spk': True, 'absensi': True, 'mobile_app': True,
            'remote_modem': True, 'monitoring_redaman': True, 'export': True,
            'whitelabel': True, 'dedicated': True,
        },
    },
}
